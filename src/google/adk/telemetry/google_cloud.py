...
def _get_api_endpoint(
  ...
  try:
    ...
    logger.warning(
        ...
        '%s. Defaulting to %s.',
        [e.value for e in MtlsEndpoint],
        MtlsEndpoint.AUTO.value,
    )
    use_mtls_endpoint = MtlsEndpoint.AUTO

  if (use_mtls_endpoint is MtlsEndpoint.ALWAYS) or (
      use_mtls_endpoint is MtlsEndpoint.AUTO and client_cert_source
  ):
